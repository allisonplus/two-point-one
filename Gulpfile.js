...
gulp.task( 'wp-pot', [ 'clean:pot' ], function () {
	...
	.pipe( wpPot( {
		...
		'destFile': 'atarr.pot',
		'package': 'atarr',
		'bugReport': 'http://www.allisontarr.com',
		'lastTranslator': 'Allison Tarr <hello@allisontarr.com>',
		'team': 'Team <hello@allisontarr.com>'
	} ) )
...
gulp.task( 'watch', function () {
	...
	browserSync( {
		...
		'proxy': 'http://underscores.dev',    // Use http://www.allisontarr.com:3000 to use BrowserSync
		'watchOptions': {
