<?php
/**
 * Profesh functions and definitions.
 *
...
function atarr_setup() {
	 ...
	 * If you're building a theme based on Profesh, use a find and replace
	...
	add_image_size('portfolio-archive', 585, 345, true);
...
function atarr_widgets_init() {
	...
	//	'sidebar-2'  => esc_html__( 'Sidebar 2', 'atarr' ),
	//	'sidebar-3'  => esc_html__( 'Sidebar 3', 'atarr' ),
	);
